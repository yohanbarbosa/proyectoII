  ...
  return (
    ...
    >
      ...
      <div className="relative h-44 bg-gradient-to-br from-stone-100 to-stone-200 flex items-center justify-center overflow-hidden">
        ...
        {!producto.url_img ? (
          <svg
            className="w-20 h-20 text-stone-300 group-hover:text-orange-200 transition-colors duration-500
        ...
        <div className="absolute top-2.5 left-2.5 flex flex-col gap-1.5">
          {producto.categorias && (
            <span
              className="bg-white/90 backdrop-blur-sm text-stone-600 text-[10px] font-bold uppercase tracking-wider
        ...
        {inCart && (
          <div
            className="absolute top-2.5 right-2.5 w-7 h-7 bg-orange-500 text-white rounded-full
      ...
      <div className="flex flex-col flex-1 p-4">
        ...
        {producto.codigo_barras && (
          <p className="text-stone-400 text-[10px] font-mono mb-3">
        ...
        <div className="flex items-center justify-between gap-2 mt-auto">
          <div>
            <p className="text-stone-400 text-[10px] uppercase tracking-wider font-semibold">
              Precio
            </p>
